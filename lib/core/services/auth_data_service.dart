import 'package:farmer_assistant_app/core/services/shared_preferences.dart';
import '../../locator.dart';
...
//this  function will update the boarding status using the sharedpreferences
  ...
  updateIsRegisterFirstTime(status) {
    isRegisteredFirstTime = status;
    _sharePrefsProvider.setIsRegisteredFirstTime(status);
  }
